...
- Verify stable install works: `composer require arjundhi/module-low-stock-notification:^1.0`.
- Verify dev fallback works for pre-tag testing: `composer require arjundhi/module-low-stock-notification:"dev-main@dev"`.
